...
if(isset($_POST['token'])){
    ...
    $stmt = $conn->prepare("DELETE FROM `images` WHERE secret = ?");
                ...
                <div class="container position-relative py-5 py-sm-6">
                    <div class="row">
                        <div class="col-12 py-sm-5">
                            <h1 class="display-4 font-weight-bold text-center">Lade und teile deine Bilder online und ganz einfach</h1>
                                        ...
                                        <form method="post" id="short-form">
                                            <input type="hidden" name="_token" value="nlkHL6ytZaudXmAsLKs8BmG3Y8LbBNq54u3keVNo">                                        <div class="form-row">
                                                <div class="col-12 col-sm">
                                                    <input type="text" dir="ltr" autocomplete="off" autocapitalize="none" spellcheck="false" name="token" class="form-control form-control-lg font-size-lg" placeholder="Gib deinen Secret-Token ein, um den Link zu löschen" autofocus="autofocus" required>

                                                </div>
                                                <div class="col-12 col-sm-auto">
                                                    <button class="btn btn-primary btn-lg btn-block font-size-lg mt-3 mt-sm-0" type="submit">Link löschen</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
