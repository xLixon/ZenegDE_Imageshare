...
<div class="d-flex flex-column flex-fill ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-8">
                                <div class="form-group mt-5" id="short-form-container">
                                    <h3>Ihr Link wurde erfolgreich gelöscht.</h3>
                                    <h4>Sie werden in kürze wieder auf die Startseite geleitet.</h4>
                                </div>
    ...
    <script>
        ...
        function copyURL() {
            ...
            /* Alert the copied text */
            alert("Der gekürtze Link wurde in die Zwischenablage kopiert.");
        }
    </script>
</body></html>
